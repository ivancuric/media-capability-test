...
function App() {
  ...
  const [capabilities, setCapabilities] = useState<DeviceCapabilitiesData | null>(null);
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center max-w-md mx-auto p-6 bg-white rounded-lg shadow-md">
          ...
          <p className="text-gray-600">
            Please allow camera access to view available devices and their capabilities.
          </p>
        </div>
      </div>
    );
      ...
      <div className="max-w-4xl mx-auto px-4">
        <div className="bg-white rounded-lg shadow-md p-6">
          <div className="flex items-center mb-6">
            ...
            <h1 className="text-2xl font-bold text-gray-900">Video Device Inspector</h1>
          </div>
